...
class RAGSettingsDialog(QDialog):
    ...
    def _init_ui(self):
        ...
        self.chunk_size_spin.setToolTip("Máx. caracteres por fragmento de conocimiento (consciente de límites de párrafo)")
        ...
        self.search_max_pages_spin.setToolTip("Máx. páginas a buscar por palabra clave")
        ...
        self.forum_max_pages_spin.setToolTip("Máx. páginas para listar hilos por foro")
        ...
        self.mirror_max_pages_spin.setToolTip("Máx. páginas de listado del foro durante el duplicado")
