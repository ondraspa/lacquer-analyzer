...
class AnalysisPanelWidget(QWidget):
    ...
    def _init_ui(self):
        ...
        self.solvent_group.setToolTip("Análisis del sistema de solventes: balance de evaporación, riesgo de empañamiento y calidad de solvencia")
        solvent_layout = QVBoxLayout()
        self.solvent_text = QTextEdit()
        self.solvent_text.setReadOnly(True)
        self.solvent_text.setToolTip("Contenido detallado del análisis del sistema de solventes con recomendaciones")
        ...
        self.coating_group.setToolTip("Propiedades del recubrimiento: sólidos estimados, viscosidad y calidad de nivelación")
        coating_layout = QVBoxLayout()
        self.coating_text = QTextEdit()
        self.coating_text.setReadOnly(True)
        self.coating_text.setToolTip("Propiedades estimadas del recubrimiento: sólidos, viscosidad y nivelación")
        ...
        self.formulation_group.setToolTip("Problemas de formulación identificados y modificaciones sugeridas para mejorar la receta")
        form_layout = QVBoxLayout()
        self.formulation_text = QTextEdit()
        self.formulation_text.setReadOnly(True)
        self.formulation_text.setToolTip("Lista de problemas de formulación y sugerencias de modificación")
        ...
        self.stats_group.setToolTip("Estadísticas resumidas de la receta actual: sólidos, viscosidad y número de componentes")
