...
class KnowledgeBrowserDialog(QDialog):
    ...
    def __init__(self, parent=None, kb=None, llm=None):
        ...
        self.browse_list.setToolTip("Lista de entradas de la base de conocimiento")
        ...
        self.corr_list.setToolTip("Lista de correcciones registradas en la base de conocimiento")
