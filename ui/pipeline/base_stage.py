...
class KnowledgeQAPanel(QWidget):
    ...
    def _init_ui(self):
        ...
        self.settings_btn.setToolTip("Configuración RAG: modelo, temperatura, top-K, prompt del sistema")
        self.settings_btn.clicked.connect(self._open_settings)
        btn_row.addWidget(self.settings_btn)

        self.agent_combo = QComboBox()
        self.agent_combo.setToolTip("Selecciona un agente específico del dominio")
        ...
        self.inspect_btn.setToolTip("Muestra qué entradas de conocimiento se usaron para esta respuesta")
