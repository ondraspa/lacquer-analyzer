...
class GalvanicsWorkspace(QWidget):
    ...
    def _init_ui(self):
        ...
        header = QLabel(T("⚡ Galvánica — Metalizado y Baños Electrolíticos"))
        header.setStyleSheet("font-weight: bold; font-size: 16px; padding: 4px;")
        header_row.addWidget(header)
        header_row.addStretch()
        manual_btn = QPushButton(T("📖 Manual — Galvánica"))
        manual_btn.setToolTip("Guía completa de galvanoplastia: historia, baños y procesos")
        manual_btn.clicked.connect(lambda: self._open_manual("electroplating"))
        ...
        silver_group = QGroupBox(T("Baño de Plata (Plateado)"))
        ...
        silver_form.addRow(T("Temperatura:"), self.silver_temp)
        ...
        silver_form.addRow(T("pH:"), self.silver_ph)
        ...
        silver_form.addRow(T("Densidad de corriente:"), self.silver_density)
        ...
        silver_form.addRow(T("Tiempo:"), self.silver_time)

        silver_group.setLayout(silver_form)
        bath_layout.addWidget(silver_group)

        nickel_group = QGroupBox(T("Baño de Sulfamato de Níquel"))
        ...
        nickel_form.addRow(T("Temperatura:"), self.nickel_temp)
        ...
        nickel_form.addRow(T("pH:"), self.nickel_ph)
        ...
        nickel_form.addRow(T("Densidad de corriente:"), self.nickel_density)
        ...
        nickel_form.addRow(T("Grosor objetivo:"), self.nickel_thickness)

        nickel_group.setLayout(nickel_form)
        bath_layout.addWidget(nickel_group)

        prep_group = QGroupBox(T("Preparación de Superficie"))
        ...
        prep_form.addRow(T("Método:"), self.prep_method)
        ...
        prep_form.addRow(T("Tiempo:"), self.prep_time)
